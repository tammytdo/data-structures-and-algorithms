...
// let regex = at the beginning of my string, look for 4 digits, or look for the 4 digits at the end of the string. Look globally.
  let regex = /^\d{4}$/g;
// test whether 'let regex' is in the string. return either true or false.
...
const validateEmail = (email) => {
  let regex = /^([a-z\d]+)\.?([a-z\d]+)@([a-z]+)\.([a-z]{3,8})$/;
