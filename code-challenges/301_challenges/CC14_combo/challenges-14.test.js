...
const toTitleCase = (arr) => {
  let finalString = [];
  arr.forEach(firstIndex => { 
    let toTitle = firstIndex[0].toUpperCase()
    let toLower = firstIndex.slice(1,);
    finalString.push(toTitle+toLower)});
  return finalString;
};
...
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
Write a function named sortBy 
- that takes in an array of objects, 
- each of which has a particular property
- and sorts those objects by that property, lowest to highest
